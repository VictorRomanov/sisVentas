...
@section ('contenido')
	...
	{!!Form::open(array('url'=>'compras/ingreso','method'=>'POST','autocomplete'=>'off'))!!}
		{{Form::token()}}
			<div class="row">
				<div class="col-lg-12 ccol-sm-12 col-md-12 col-xs-12">
			...
			<div class="row">
				<div class="panel panel-primary">
					<div class="panel-body">
						...
						<div class="col-lg-2 col-sm-2 col-md-2 col-xs-12">
							<div class="form-group">
								<button type="button" id="bt_add" class="btn bg-primary">Agregar</button>
							</div>
						</div>
			...
			@push('scripts')
				<script>
					...
					function agregar() {
						...
						articulo=$("#pidarticulo option:selected").text();//texto seleccionado en el option
